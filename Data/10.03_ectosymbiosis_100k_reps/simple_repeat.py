...
directory = "ecto_reps/rpts/" #set this to whichever directory you would like data files stored in
seeds = range(1001,1031)
...
for a in seeds:
    for vt in vts:
        for e in ecto:
            for ei in ecto_im:
                if ei == e: #we no longer care about immunity off
